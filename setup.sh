...
if [ ! -d "$RUNNING_NG_DIR" ]; then
  ...
  git clone https://github.com/anupli/running-ng.git $RUNNING_NG_DIR
  git -C $RUNNING_NG_DIR checkout 53b4be62b48e00fceab6308cdc8c4d4cf7e10000
...
if [ ! -d "$JDK21_COUNTER_DIR" ]; then
  ...
  git clone https://github.com/openjdk/jdk21u.git $JDK21_COUNTER_DIR
  git -C $JDK21_COUNTER_DIR checkout 7069f193f1f8c61869fc68a36c17f3a9a7b7b2a0
...
if [ ! -d "$JDK21_SIMULATOR_DIR" ]; then
  ...
  git clone https://github.com/openjdk/jdk21u.git $JDK21_SIMULATOR_DIR
  git -C $JDK21_SIMULATOR_DIR checkout 7069f193f1f8c61869fc68a36c17f3a9a7b7b2a0
